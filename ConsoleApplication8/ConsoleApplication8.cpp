...
{
    // ===== 新增：窗口初始化 =====
    system("title Tetris Game - 俄罗斯方块");
    
    // 方案1：使用原始尺寸 80x40（推荐，游戏区域比例最佳）
    SetConsoleWindowSize(80, 40);
    
    // 方案2：如果你想接近 1002x762（取消注释下面两行，并注释上面那行）
    // SetConsoleWindowSize(62, 47);
    ...
    while (!bGameOver)
    {
        ...
        // 显示分数
        swprintf_s(&screen[2 * nScreenWidth + nFieldWidth + 6], 16, L"SCORE: %8d", nScore);  // 修正了拼写 SCIRE -> SCORE
    ...
    cout << "           GAME OVER!" << endl;
    cout << "=====================================" << endl;
    cout << "         您的分数是: " << nScore << endl;
    cout << "         Your score: " << nScore << endl;
    cout << "=====================================" << endl;
    cout << endl;
    cout << "     按回车键或任意键退出游戏..." << endl;
